...
KEYWORD_MAP: dict[str, list[str]] = {
    'politics': [
        ...
        '政治', '选举', '制裁', '外交',
        'Approval Rating', 'General Election', 'Election Fraud',
        'Trade Policy', 'Freedom of Speech', 'House of Representatives',
        'Local Government', 'OPEC', 'Energy Market',
        'Ballot Counting', 'Campaign Finance', 'Healthcare Policy',
        'Energy Policy', 'Cyber Warfare',
    ],
    'business': [
        ...
        'ビジネス', '経営', '企業',
        'Labor Market', 'Global Trade', 'Net Income', 'Private Equity',
        'Yield Curve', 'Initial Public Offering', 'Board of Directors',
        'Cash Flow', 'EBITDA', 'Bear Market', 'Commercial Real Estate',
        'Office Space', 'Cyber Monday', 'Earnings Call', 'Dividend Yield',
        'Index Fund',
    ],
    'ai': [
        'LLM', ' GPT', ' AI ', ' AI,', ' AI.',
    ...
    'technology': [
        ...
        'テクノロジー', 'スマートフォン', '技術革新',
        'Apple Pay', 'Game Engine', 'Metaverse', 'Big Data', 'Mixed Reality',
        'Edge Computing', 'Health Tech', 'Digital Wallet', 'Google Pay',
        'Wind Power', 'Smart Home',
    ],
    'science': [
    ...
    'society': [
        ...
        '健康', '医療', '病院',
        'Press Freedom', 'Education Policy',
    ],
    'sports': [
        ...
        '野球', 'スポーツ', 'サッカー', 'バスケ',
        'Rory McIlroy', 'Carlos Alcaraz', 'ATP Tour', 'Scottie Scheffler',
        'Max Verstappen', 'Lewis Hamilton', 'Masters Tournament',
        'Patrick Mahomes', 'Red Card', 'Giannis Antetokounmpo', 'Joel Embiid',
        'Erling Haaland', 'Mohamed Salah', 'Novak Djokovic', 'Iga Swiatek',
        'Ryder Cup', 'Final Four', 'Rookie of the Year',
        'Nikola Jokic', 'Luka Doncic', 'Jayson Tatum', 'Aaron Rodgers',
        'Josh Allen', 'Kylian Mbappe', 'Vinicius Jr', 'Jude Bellingham',
        'Rafael Nadal', 'Charles Leclerc',
        'US Open Tennis', 'French Open Tennis', 'Australian Open',
        'WTA Tour', 'Copa America', 'Euro Cup', 'Tour de France',
        'All-Star Game', 'Transfer Window', 'Golden Boot', "Ballon d'Or",
        'Hat-trick', 'Yellow Card', 'Three-pointer', 'Free Throw',
        'Track and Field',
    ],
    'entertainment': [
