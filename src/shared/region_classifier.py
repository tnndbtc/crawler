...
KEYWORD_MAP = {
    'cn': ['中国', '北京', '上海', '深圳', '习近平', 'China', 'Beijing',
           'Shanghai', 'Chinese'],
    'jp': ['日本', '東京', '大阪', 'Japan', 'Tokyo'],
    'kr': ['한국', '서울', 'Korea', 'Seoul'],
    'us': ['美国', 'Trump', 'Biden', 'White House', 'Washington DC',
           'United States', 'U.S.'],
    'ru': ['Россия', 'Москва', 'Путин', 'Russia', 'Moscow', 'Putin'],
    'in': ['India', 'Modi', 'Delhi', 'Mumbai', 'भारत'],
    'de': ['Deutschland', 'Berlin', 'München', 'Scholz', 'Merz',
           'Germany', 'German', 'Bundesliga'],
    'fr': ['France', 'Paris', 'Macron', 'Lyon', 'Marseille', 'français'],
    'br': ['Brasil', 'Brasília', 'Lula', 'São Paulo', 'Rio de Janeiro',
           'Brazil', 'Bolsonaro'],
    'es': ['España', 'Madrid', 'Barcelona', 'Sánchez', 'Spain', 'Spanish'],
    'it': ['Italia', 'Roma', 'Milano', 'Meloni', 'Italy', 'Italian'],
    'tr': ['Türkiye', 'Ankara', 'İstanbul', 'Erdoğan', 'Turkey', 'Turkish'],
    'ar': ['السعودية', 'مصر', 'دبي', 'الرياض', 'القاهرة',
           'Saudi', 'Egypt', 'Dubai', 'Riyadh', 'Cairo'],
    'id': ['Indonesia', 'Jakarta', 'Jokowi', 'Prabowo'],
    'pl': ['Polska', 'Warszawa', 'Kraków', 'Tusk', 'Poland', 'Polish'],
    'nl': ['Nederland', 'Amsterdam', 'Den Haag', 'Netherlands', 'Dutch'],
    'se': ['Sverige', 'Stockholm', 'Sweden', 'Swedish'],
    'ph': ['Pilipinas', 'Manila', 'Marcos', 'Philippines', 'Filipino'],
    'vn': ['Việt Nam', 'Hà Nội', 'Sài Gòn', 'Vietnam', 'Vietnamese'],
    'th': ['ประเทศไทย', 'กรุงเทพ', 'Bangkok', 'Thailand', 'Thai'],
    'my': ['Malaysia', 'Kuala Lumpur', 'Anwar', 'Malaysian'],
    'pt': ['Portugal', 'Lisboa', 'Porto', 'Portuguese'],
    'ar_latam': ['Argentina', 'Buenos Aires', 'Milei', 'Argentino'],
}
